    ...
    <div className="h-screen flex flex-col justify-center items-center dark:bg-black">
      ...
      <div className="flex gap-8 justify-center">
        <Card
          ...
          className="bg-amber-100/50 dark:bg-amber-800/50 w-1/3 h-full hover:-translate-y-3 transition-transform"
        >
        ...
        <Card
          ...
          className="bg-sky-100/50 dark:bg-sky-800/50 w-1/3 h-full hover:-translate-y-3 transition-transform"
        >
          <CardHeader className="flex-col !items-center">
